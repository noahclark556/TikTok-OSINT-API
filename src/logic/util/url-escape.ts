...
const originalUrl = 'http://localhost:8080/osintx?username=realdonaldtrump&apikey=CUSTOM_API_KEY&query={"bio":true,"name":true,"following":true,"followers":true,"posts":5,"aidescription":true}';
